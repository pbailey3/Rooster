        ...
        base.init = function(){
            ...
            if (base.links.length > 0){
                ...
                for (var i = 0; i < base.links.length; i++) {
                    ...
                    sub_fab_btns_dom += "<div><button class='sub_fab_btn' href='" + (base.links[i].url ? base.links[i].url : "") + "' data-ajax-update='#body' data-ajax-mode='replace' data-ajax-method='GET' data-ajax-loading='#divLoading' data-ajax-complete='DocumentReady' data-ajax='true' class='sub_fab_btn' >"+base.links[i].label+"<span style='" + color_style + "'></span></button></div>";
